...
function calcCirc() {
    ...
    document.getElementById('varResult').placeholder = `Número de cabos do tipo ${varCable.value} que cabem no eletroduto de ${varEletro.value} (${eletroSelected}) são: ${numCables}`;


    console.log(`Número de cabos do tipo ${varCable.value} que cabem no eletroduto de ${varEletro.value} (${eletroSelected}) são: ${numCables}`);
